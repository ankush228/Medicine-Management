...
<form class="form" action="delete_phpmedicines.php" method="POST">
					<div style="background-color: #EEEEEE;float: right;width: 550px;padding-right: 20px;margin-right: 500px; border-radius:50px; border-color: black; border-style: solid;">
						<h2 style="color:#cd15a6; text-align: right;">Delete Medicine</h2>
						<table border="0" align="center" width = "350" style="font-family:georgia;font-size:15px;">
							...
							<tr>
								<td colspan = "2">
								<br>
									<input type="submit" name="delete" value = "Delete!" style="margin-left:14.5px; background:#cd15a6;border:none; color:white; font-family:georgia; font-size:14px; height: 25px; width: 120px; border-radius:5px; position:relative; left: 330px; top: -50px;">
