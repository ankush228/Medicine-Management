...
<form class="form" action="delete_phpcompanies.php" method="POST">
					<div style="background-color: #EEEEEE;float: right;width: 550px;padding-right: 20px;margin-right: 500px; border-radius:50px; border-color: black; border-style: solid;">
						<h2 style="color:#cd15a6; text-align: right;">Delete Company</h2>
						<table border="0" align="center" width = "350" style="font-family:georgia;font-size:15px;">
							<tr>
								...
								<td align="left" style="color:red;">
									<input style = "height:25px; padding-left:10px;border-radius:5px;" size = "25" type="text" name="productname" placeholder="Company Name" required = "true"/>
